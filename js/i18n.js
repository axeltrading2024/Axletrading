...
(function () {
  ...
  var I18N = {
    ...
    faq1_a:             { en: '<p>Browse the catalog and add each item to your inquiry list — one tap per item and no account needed. Then send the list to Eddy on WhatsApp or by email: the site writes the message for you.</p><p>You get a quote within 24 hours with the unit price, MOQ and shipping cost. We start picking and packing once payment is confirmed, and we send you the tracking number as soon as your parcel leaves.</p>',
                           es: '<p>Explora el catálogo y añade cada artículo a tu lista de cotización — un toque por artículo y sin cuenta. Luego envía la lista a Eddy por WhatsApp o por email: el sitio escribe el mensaje por ti.</p><p>Recibes una cotización en 24 h con el precio unitario, el MOQ y el costo de envío. Empezamos a preparar y empacar al confirmar el pago, y te enviamos el número de seguimiento en cuanto sale el paquete.</p>' },
    ...
    faq2_a:             { en: '<p>MOQ is flexible and varies by product. Some items ship as single units for testing; better prices kick in at volume. Just ask on WhatsApp for the exact MOQ of anything you’re interested in.</p>',
                           es: '<p>El MOQ es flexible y varía según el producto. Algunos artículos se envían como unidades sueltas para probar; mejores precios entran a volumen. Pregunta por WhatsApp el MOQ exacto de lo que te interese.</p>' },
    ...
    faq3_a:             { en: '<p>Yes. Samples are recommended for first-time buyers — you only pay the sample price plus shipping. The sample cost can often be deducted from your first bulk order.</p>',
                           es: '<p>Sí. Recomendamos muestras para compradores primerizos — solo pagas el precio de muestra más el envío. El costo de la muestra a menudo se descuenta de tu primer pedido grande.</p>' },
    ...
    faq8_a:             { en: '<p>For many products, yes — custom logo, packaging and inserts are possible at higher quantities. Message Eddy with your idea and target quantity to check feasibility.</p>',
                           es: '<p>Para muchos productos, sí — logotipo, empaque e insertos personalizados son posibles a cantidades mayores. Escríbele a Eddy tu idea y cantidad objetivo para ver viabilidad.</p>' },
    ...
    faq9_a:             { en: '<p>Send photos on WhatsApp within 7 days of delivery. We’ll arrange a replacement or refund on the affected units — we keep buyers coming back by keeping this simple.</p>',
                           es: '<p>Envía fotos por WhatsApp en 7 días tras la entrega. Gestionamos un reemplazo o reembolso de las unidades afectadas — mantenemos a los compradores volviendo por mantener esto simple.</p>' },
